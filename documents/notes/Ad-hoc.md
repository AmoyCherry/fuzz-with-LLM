...
```
/home/parallels/Downloads/GoLand-2022.3.4/plugins/go-plugin/lib/dlv/linux/dlv --listen=:2345 --headless=true --api-version=2 --accept-multiclient exec ./bin/syz-manager -- -config=./cfgs/isolated.cfg
```

2. attach

```
/home/parallels/Downloads/GoLand-2022.3.4/plugins/go-plugin/lib/dlv/linux/dlv attach 129931 --headless --api-version=2 --log --listen=:2345
```
