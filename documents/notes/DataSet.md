...
>
> Size: 1.5M in total, with 0.4M `clock_gettime`
...
We may need a filter for this dataset to adjust the massive number of `clock_gettime`. I concern about it will impact the model to predict clock_gettime frequently. 
...
> can be used for us? - YES✅
>
> Size: 43M in total, and 14M diverse calls
...
>
> can be used for us? - ⚠️ no arguments
>
> Size: 12 Billion calls
...
## ADFA IDS from UNSW ⚠️

> [Dataset](https://research.unsw.edu.au/projects/adfa-ids-datasets)
>
> can be used for us? ⚠️ no arguments, only has syscall numbers
>
> Size: [2.7M calls](https://learn.saylor.org/mod/book/view.php?id=29755&chapterid=5445)

```
# dataset snippest
168 3 265 265 168 168 43 168 265 168 168 3 3 168
```
